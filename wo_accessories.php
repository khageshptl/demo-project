...
$rs = mysqli_query($cn, "SELECT * FROM getimg WHERE category = 'women accessories'") or die("value not found");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <a href="#scrolltomainsec" style="cursor: default;">
        <div class="men-banner" style="background-image: url('admin_image/banner9.jpeg');"></div>
    </a>
    <br>
    <br>
    <h1 id="scrolltomainsec" style="margin-left: 68px;">WOMEN'S ACCESSORIES</h1>
    <div class="heading-line" style="width: 230px;"></div>
