...
$rs = mysqli_query($cn, "SELECT * FROM getimg WHERE category = 'women shoes'") or die("value not found");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <a href="#scrolltomainsec" style="cursor: default;">
        <div class="men-banner" style="background-image: url('admin_image/banner8.jpg');"></div>
    </a>
    <br>
    <br>
    <h1 id="scrolltomainsec" style="margin-left: 68px;">WOMEN'S FOOTWEAR</h1>
