...
$rs = mysqli_query($cn, "SELECT * FROM getimg WHERE category = 'men shoes'") or die("value not found");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <a href="#scrolltomainsec" style="cursor: default;">
        <div class="men-banner" style="background-image: url('admin_image/banner3.jpeg');"></div>
    </a>
    <br>
    <br>

    <h1 id="scrolltomainsec" style="margin-left: 68px;">MEN'S FOOTWEAR</h1>
    <div class="heading-line" style="width: 150px;"></div>
