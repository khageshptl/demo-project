...
<header style="position: static;">
    <div class="navbar">
        ...
        <div class="nav-right-item">
            <div class="nav-items">
                <a href="men.php" style="color: #0d1b2a; border-bottom: 0.5px solid black;">MEN</a>
...
<div class="panel-top">
    <a href="men.php">TOPWEAR</a>
    <a href="men_bottom.php">BOTTOMWEAR</a>
    <a href="men_shoes.php">SHOES</a>
    <a href="men_accessories.php">OTHER ACCESSORIES</a>
    <a href="men_theme.php">SHOP BY THEMES</a>
</div>