...
$rs = mysqli_query($cn, "SELECT * FROM getimg WHERE category = 'kids boy' OR category = 'kids girl'") or die("value not found");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <a href="#scrolltomainsec" style="cursor: default;">
        <div class="men-banner" style="background-image: url('admin_image/banner14.webp');"></div>
    </a>
    <br>
    <br>
    <h1 id="scrolltomainsec" style="margin-left: 68px;">KIDS COLLECTION BY THEME</h1>
