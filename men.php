...
$rs = mysqli_query($cn, "SELECT * FROM getimg WHERE category = 'men top'") or die("value not found");
...
<body>
    ...
    <a href="#scrolltomainsec" style="cursor: default;">
        <div class="men-banner" style="background-image: url('admin_image/banner.jpg');"></div>
    </a>
    <br>
    <br>

    <h1 id="scrolltomainsec" style="margin-left: 68px;">MEN'S TOPWEAR</h1>
    ...
    <div class="shop-palettes">
        ...
        ?>
        <script>
            var btnvar1 = document.getElementById("wishlist");
            function toggle1() {
