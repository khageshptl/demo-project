...
$rs = mysqli_query($cn, "SELECT * FROM getimg WHERE category = 'kids vacation'") or die("value not found");
...
<body>
    ...
    <a href="#scrolltomainsec" style="cursor: default;">
        <div class="men-banner" style="background-image: url('admin_image/banner13.webp');"></div>
    </a>
    <br>
    <br>

    <h1 id="scrolltomainsec" style="margin-left: 68px;">VACATION WEAR</h1>
    <div class="heading-line" style="width: 170px;"></div>
